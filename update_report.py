...
def ai_meeting_results():
    ...
    summary = {
        ...
        "코인/레버리지": "이더리움 현물 수급 폭발. 가상자산 관련주(MSTR, MARA) 및 레버리지 종목 변동성 극대화 포착."
    }
    recs = [
...
def generate_html(data, ultra_beast, summary, recs, options, earnings):
    try:
        ...
        options_html = "".join([f'''
            <div class="bg-white dark:bg-[#151515] p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm relative overflow-hidden">
